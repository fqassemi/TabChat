...
export class SQLiteVectorStoreImpl {
    constructor(dbPath) {
    ...
    async addDocuments(docs, apiKey) {
        ...
        for (const d of docs) {
            ...
            await this.db.run(`INSERT INTO documents (content, metadata, embedding) VALUES (?, ?, ?)`, d.text, JSON.stringify(d.metadata), JSON.stringify(embedding));
        }
...
//# sourceMappingURL=SQLiteVectorStoreImpl.js.map