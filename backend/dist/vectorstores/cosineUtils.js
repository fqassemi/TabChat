 ...
 */
export function similaritySearchLocal(queryEmbedding, docs, k) {
    const ranked = docs
        .map((d) => {
        let embedding = [];
        ...
        if (typeof d.embedding === "string") {
            try {
                ...
                console.warn("⚠️ Invalid embedding format for doc:", d.metadata?.title || d.text?.slice(0, 50));
                embedding = [];
            }
        }
...
//# sourceMappingURL=cosineUtils.js.map