...
function openSearchOverlay(): void {
  ...
  function closeOverlay() {
    ...
    const bd = shadow.querySelector(".backdrop") as HTMLElement;
  ...
  resultsDiv.querySelectorAll<HTMLElement>(".item").forEach((el) => {
    el.addEventListener("click", (e) => {
      if ((e.target as HTMLElement).tagName === "A") return; // خود لینک جدا هندل میشه
